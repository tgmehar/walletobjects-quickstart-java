...
public class Loyalty {
  ...
  public static LoyaltyObject generateLoyaltyObject(Long issuerId, String classId, String objectId){
    ...
    WalletObjectMessage message = new WalletObjectMessage()
      .setHeader("Hi Joe")
      .setBody("Click here for a coupon to use at your local Baconrista shop!")
  ...
  public static LoyaltyClass generateLoyaltyClass(Long issuerId, String classId){
    ...
    infoModule.put("row0", new TypedValue()
      .set("col0", new TypedValue()
        .set("label", new TypedValue().setString("Label 0"))
        .set("value", new TypedValue().setString("Value 0")))
      .set("col1", new TypedValue()
        .set("label", new TypedValue().setString("Label 1"))
        .set("value", new TypedValue().setString("Value1"))));
    infoModule.put("row1", new TypedValue()
      .set("col0", new TypedValue()
        .set("label", new TypedValue().setString("Label 0"))
        .set("value", new TypedValue().setString("Value 0")))
      .set("col1", new TypedValue()
    ...
    LoyaltyClass wobClass = new LoyaltyClass()
      ...
      .setProgramLogo(new Image().setSourceUri(new Uri().setUri("http://www.google.com/landing/chrome/ugc/chrome-icon.jpg")))
      .setRewardsTierLabel("Tier")
      .setRewardsTier("Gold")
      .setAccountNameLabel("Member Name")
